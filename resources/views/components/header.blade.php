<header x-data="{ open: false, servicesOpen: false, mobileServicesOpen: false }" class="bg-white shadow-md sticky top-0 z-50">
    ...
    <div x-show="open" x-cloak class="md:hidden bg-white border-t">
        ...
        <div>
            ...
            <div x-show="mobileServicesOpen" x-cloak class="bg-gray-50 pl-4 border-l-2 border-brand-orange">
                ...
                <a href="#" @click="open = false" class="block py-2 px-4 text-gray-600 hover:text-brand-orange transition">Area Layanan</a>
            </div>
        </div>
